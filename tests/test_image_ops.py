...
from mlutils.image_ops.filter import filter_dataset_by_dimension
...
class TestDataOpsSplitDataset():
    def test_filter_dataset_by_dimension_valid(self):
        filter_dataset_by_dimension(source_20, target_20, 150, 150)
    ...
    def test_filter_dataset_by_dimension_valid_2(self):
        filter_dataset_by_dimension(source_20, target_20, 0, 0)
